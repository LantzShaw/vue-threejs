...
const changeColor = () => {
  ...
  console.log('----id----', obj, selectedModel.name)

  //   for (let i = 0; i < obj.length; i++) {
  //     if (obj[i].name == selectedModel.name) {
...
const clickModel = event => {
  ...
  if (intersects.length) {
    ...
    if (res) {
      ...
      //   if (selectedModel.name === intersects[0].object.parent.name) {
      //     return
      //   } else {
      //     selectedModel.name = intersects[0].object.parent.name
